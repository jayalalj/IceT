...
(function(){
  ...
  var P={ name:[662,94,276,30], faceoff:[662,148,80,26], breakout:[748,148,84,26], dzone:[838,148,86,26],
  ...
  var SCENES=[[0,'1 · Pick a starting setup'],[2.4,'2 · Name the play'],[5.2,'3 · Add a step'],[6.8,'4 · Drag players and the puck to where they END up'],
  ...
  function state(t){
    ...
    if(t>=30.8) s.toast='Link copied! Text it to Janaka or the team.';
  ...
  function panel(c,s){
    ...
    label(c,662,143,'Start from'); btn(c,P.faceoff,'Faceoff','chip',s.tpl); btn(c,P.breakout,'Breakout','chip'); btn(c,P.dzone,'D-zone','chip');
